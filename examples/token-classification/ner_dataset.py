...
class Masakhaner(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        MasakhanerConfig(name="en", version=datasets.Version("1.0.0"), description="CoNLL 2003 English dataset"),
    ...
    def _split_generators(self, dl_manager):
        ...
        if self.config.name == 'en':
            ...
            prefix = f'{_MASAKHANE_URL}/{self.config.name}'
            dev_file = 'dev.txt'
        urls_to_download = {
            "train": f"{prefix}/train.txt",
            "dev": f"{prefix}/{dev_file}",
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for line in f:
                ...
                if line == "" or line == "\n":
                    ...
                    ner_tag = splits[-1]
                    ner_tag = 'O' if 'DATE' in ner_tag or 'MISC' in ner_tag else ner_tag
